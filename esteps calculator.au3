...
#Region ### START Koda GUI section ### Form=estep_calculator Koda FormDesigner.kxf


$Form1_1 = GUICreate("Estep Calculator", 331, 558, 1021, 383)

$Label1 = GUICtrlCreateLabel("Step 1: Connect to the printer.", 16, 16, 145, 17)
GUICtrlSetTip(-1, "OctoPrint, or other interface to do next steps!")
...
GUICtrlSetTip(-1, "Measuring from extruder to measured amount.")

$Label4 = GUICtrlCreateLabel("Step 4: Mark filament 120 mm from entering extruder.", 16, 88, 250, 17)
GUICtrlSetTip(-1, "Measure to marked line once extruded.")

$Label5 = GUICtrlCreateLabel("Step 5: Extrude 100mm of filament.", 16, 112, 168, 17)
GUICtrlSetTip(-1, "Should have 20mm to marked line.")

$Label6 = GUICtrlCreateLabel("G1 E100 F100", 112, 136, 73, 17)
GUICtrlSetTip(-1, "Copy Terminal codes on click.")


$Label7 = GUICtrlCreateLabel("Step 6: Measure total extruded filament.", 16, 168, 238, 17)
GUICtrlSetTip(-1, "Enter the amount in the box below.")
...
$Label14 = GUICtrlCreateLabel("Current Esteps:", 125, 336, 85, 17)
...
$Pic1 = GUICtrlCreatePic("M92_EstepsExample.jpg", 8, 248, 321, 33)
...
$Label17 = GUICtrlCreateLabel("=", 208, 336, 10, 17)
...
While 1
	...
	Switch $nMsg
		...
		Case $Input1
			...
			GUICtrlSetData($extrudedValue, $inputVal1&")     X ")
